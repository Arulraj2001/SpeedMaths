        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              Accelerate your mental computation skills. Built for students, professionals, and coding interviews. Master mental maths with daily workouts.
            </p>
        ...
        <div id="newsletter" className="mt-12 border-t border-border/40 pt-8 lg:flex lg:items-center lg:justify-between">
          <div className="max-w-md">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              Weekly curated quick math short-cuts, formulas, and power drill PDFs delivered straight to your email.
            </p>
          </div>
